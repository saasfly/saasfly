...
const meteors_data : Meteor[] = [
  {name: "Saasfly Github", description: "What are you waiting for? Just kickoff your next App", button_content: "Get Started"},
  {name: "Saasfly Docs", description: "Your complete All-in-One solution for building SaaS services.", button_content: "Explore"},
  {name: "Discord", description: "Join our Discord server to chat with other developers and get help.", button_content: "Chat with us"}
]
...
export default async function IndexPage({
  ...
  return (
    <>
      ...
      <section
          id="saasfly"
          className="container space-y-6 bg-slate-50 py-8 dark:bg-transparent md:py-12 lg:py-12 mb-8"
      >
